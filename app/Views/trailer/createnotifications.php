<div class="card">
  <div class="card-body">
    <h4 class="card-title">Nueva Notificación <a href="/trailer/notifications/<?= $car["id"]?>" class=" float-right btn btn-sm btn-primary">Listado de Notificaciones</a></h4>
	<h6 class="card-subtitle mb-2 text-muted">Registrar una nueva notificación </h6>
	<hr>
		<form method="post" action="/trailer/storenotification">
			...
			<input type="hidden" name="trailer" value="<?= $car["id"] ?>" />
