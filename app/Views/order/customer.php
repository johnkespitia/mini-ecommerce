<div class="card">
  <div class="card-body">
    <h4 class="card-title">Listado de Ordenes de <span class="badge badge-info"><?= $customer["name"] ?></span><a href="/order/new" class=" float-right btn btn-sm btn-primary">Nueva Orden</a></h4>
