...
class NotificationCarModel extends Model{

	const TABLE = "car_notifications";
	...
	public function create($fields){
		$sql = "INSERT INTO ".self::TABLE." (car, notification_type, value_type,value_compare,avg_reminder) value (
