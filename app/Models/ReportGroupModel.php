...
class ReportGroupModel extends Model{
	...
	public function all(){
		...
		cm.name client_name, cm.dni client_dni, cm.email client_email, cm.phone client_phone, cm.address client_address, cty.name client_city, count(dr.id) rows_report 
	...
	public function create($fields){
		$sql = "INSERT INTO ".self::TABLE." (date_report,  service_type, area, car, customer) value (
