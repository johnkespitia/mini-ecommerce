...
class ContactModel extends Model{
	...
	public function all(){
		$sql = 'SELECT c.id, c.title, c.datetime_start, c.datetime_end, c.description, c.type, c.order_id, c.user_id, c.customer_id,
	...
	public function create($fields){
		...
		customer_id,datetime_start,datetime_end, order_id) value (
